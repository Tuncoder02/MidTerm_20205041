...
--5--
 ...
 alter TABLE locations alter column country_id type integer USING country_id::integer
--6--
...
alter table locations drop CONSTRAINT locations_pk cascade --#drop first 
alter table locations add CONSTRAINT locations_pk  PRIMARY key (location_id,country_id) 
